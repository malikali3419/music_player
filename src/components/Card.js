...
function Card({ element }) {
  ...
  return (
    <div key={element.id} className="col-lg-3 col-md-6 py-2">
      <div className="card box-shadow border-radius m-4 ">
        <div className="ratio ratio-1x1 bg-secondary bg-opacity-25 border-radius">
          <img
            src={element.album.images[0].url}
            className="card-img-top border-radius"
            alt="..."
          />
        </div>
